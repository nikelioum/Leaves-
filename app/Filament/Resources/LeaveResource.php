...
class LeaveResource extends Resource
{
    ...
    {
        return $table
            ->columns([TextColumn::make('user.name')->searchable()->label('Name'), TextColumn::make('user.lastname')->label('Lastname')->searchable(), TextColumn::make('type.name'), TextColumn::make('start_date'), TextColumn::make('end_date'), TextColumn::make('days')])
            ->filters([
